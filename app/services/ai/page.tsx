            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="ml-3 text-gray-700 font-light">Custom ML model development and training</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-cyan-600 flex-shrink-0 mt-0.5" />
                  <span className="ml-3 text-gray-700 font-light">AI strategy and roadmap development</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-cyan-600 flex-shrink-0 mt-0.5" />
                  <span className="ml-3 text-gray-700 font-light">Computer vision and image recognition systems</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-cyan-600 flex-shrink-0 mt-0.5" />
                  <span className="ml-3 text-gray-700 font-light">Natural language processing and chatbots</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-cyan-600 flex-shrink-0 mt-0.5" />
                  <span className="ml-3 text-gray-700 font-light">Predictive analytics and forecasting</span>
                </li>
              </ul>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <h3 className="text-xl font-light tracking-tight text-gray-900 mb-3">Machine Learning</h3>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <h3 className="text-xl font-light tracking-tight text-gray-900 mb-3">Deep Learning</h3>
              <p className="text-gray-600 text-sm leading-relaxed font-light tracking-tight mb-4">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <h3 className="text-xl font-light tracking-tight text-gray-900 mb-3">Data Engineering</h3>
              <p className="text-gray-600 text-sm leading-relaxed font-light tracking-tight mb-4">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <h3 className="text-xl font-light tracking-tight text-gray-900 mb-3">Predictive Analytics</h3>
              <p className="text-gray-600 text-sm leading-relaxed font-light tracking-tight mb-4">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <h3 className="text-xl font-light tracking-tight text-gray-900 mb-3">AI Ethics & Governance</h3>
              <p className="text-gray-600 text-sm leading-relaxed font-light tracking-tight mb-4">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <h3 className="text-xl font-light tracking-tight text-gray-900 mb-3">AI Automation</h3>
              <p className="text-gray-600 text-sm leading-relaxed font-light tracking-tight mb-4">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-xl font-light tracking-tight text-gray-900 mb-3">Healthcare & Life Sciences</h3>
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-xl font-light tracking-tight text-gray-900 mb-3">Financial Services</h3>
              <ul className="space-y-2 text-gray-600 font-light">
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-xl font-light tracking-tight text-gray-900 mb-3">Retail & E-commerce</h3>
              <ul className="space-y-2 text-gray-600 font-light">
            ...
            <div className="border border-gray-200 rounded-lg p-6">
              <h3 className="text-xl font-light tracking-tight text-gray-900 mb-3">Manufacturing</h3>
              <ul className="space-y-2 text-gray-600 font-light">
